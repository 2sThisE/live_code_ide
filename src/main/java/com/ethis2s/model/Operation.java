...
public class Operation {
    ...
    // 삽입 연산용 생성자
    public Operation(Type type, int position, String text, int cursorPosition, long version) {
        if (type != Type.INSERT) {
    ...
    // 삭제 연산용 생성자
    public Operation(Type type, int position, int length, int cursorPosition, long version) {
        if (type != Type.DELETE) {
