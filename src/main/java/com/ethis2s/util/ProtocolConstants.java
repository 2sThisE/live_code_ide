...
public final class ProtocolConstants {
    ...
    public static final int UF_REGISTER_REQUEST = 0x004; // Register request
    ...
    public static final int UF_FILETRE_LIST_REQUEST=0x009;
    public static final int UF_FILETRE_LIST_RESPONSE=0x00A;
